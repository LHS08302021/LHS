...
<section class="border bg-white m-4 p-0">
  <h5 for="" class="w-100 bg-light p-3 text-center">Add Track and Strands</h5>
      ...
      <table class="table table-borderless table-light border table-striped mt-4">
        ...
        <tbody id="tierTable">
          <tr>
            ...
            <td><input type="text" class="form-control" placeholder="Description Here..."></td>
...
<section class="border bg-white m-4 mt-5 p-0">
  <h5 for="" class="w-100 bg-light p-3 text-center">View Track and Strands</h5>
  <div class="px-4 py-2 pb-4">
